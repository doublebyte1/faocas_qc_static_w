...
"font: 75 10pt \"Fixedsys\";"));
        ...
        dtStart->setMinimumDate(QDate(1969, 12, 28));
        ...
        dtEnd->setMinimumDate(QDate(1969, 12, 28));
    ...
    void retranslateUi(QWidget *FrmTrip)
    {
        ...
        timeStart->setDisplayFormat(QApplication::translate("FrmTrip", "hh:mm AP", 0, QApplication::UnicodeUTF8));
        ...
        timeEnd->setDisplayFormat(QApplication::translate("FrmTrip", "hh:mm AP", 0, QApplication::UnicodeUTF8));
