...
"font: 75 10pt \"Fixedsys\";"));
        ...
        dtStart->setMinimumDate(QDate(1969, 12, 30));
    ...
    void retranslateUi(QWidget *FrmOperation)
    {
        ...
        timeStart->setDisplayFormat(QApplication::translate("FrmOperation", "hh:mm AP", 0, QApplication::UnicodeUTF8));
        ...
        timeEnd->setDisplayFormat(QApplication::translate("FrmOperation", "hh:mm AP", 0, QApplication::UnicodeUTF8));
